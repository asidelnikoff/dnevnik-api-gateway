...
using Dnevnik.ApiGateway.Infrastructure.Exceptions;
...
public class ExceptionMiddleware(RequestDelegate next, ILogger<ExceptionMiddleware> logger)
{
    ...
    private BusinessException ConvertToBusinessException(Exception ex) => ex switch
    {
        ...
        ApiServiceException apiServiceException => new BusinessException(
            apiServiceException.Message,
            apiServiceException.Answer
        )
        {
            ErrorText = apiServiceException.ErrorText
        },
